...
class GameOverPage extends StatelessWidget {
  ...
  static Page<void> page() {
    return const MaterialPage(child: GameOverPage());
  }
                ...
                children: [
                  ...
                  GameElevatedButton.icon(
                    ...
                    gradient: const LinearGradient(
                      ...
                      colors: [Color(0xFFA6C3DF), Color(0xFF79AACA)],
                    ),
                  ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          colors: [Color(0x80EAFFFE), Color(0x80C9D9F1)],
        ),
          ...
          RichText(
            text: TextSpan(
              ...
              children: [
                ...
                TextSpan(text: l10n.pts, style: const TextStyle(fontSize: 24)),
              ],
            ),
          ),
        ],
