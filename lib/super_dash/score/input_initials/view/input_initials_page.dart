...
class InputInitialsPage extends StatelessWidget {
  ...
  static Page<void> page() {
    return const MaterialPage<void>(child: InputInitialsPage());
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TraslucentBackground(
                  gradient: const [Color(0xFFB1B1B1), Color(0xFF363567)],
              ...
              const Text('Enter your initials', textAlign: TextAlign.center),
